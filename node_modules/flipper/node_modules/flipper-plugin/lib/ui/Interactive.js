...
class Interactive extends react_1.default.Component {
    ...
    getPossibleTargetWindows(rect) {
        ...
        if (siblings) {
            for (const key in siblings) {
                ...
                if (win) {
                    const distance = snap_1.getDistanceTo(rect, win);
    ...
    calculateMove(event) {
        ...
        if (event.altKey) {
            ...
            newLeft = snap_1.maybeSnapLeft(snapProps, windows, newLeft);
            newTop = snap_1.maybeSnapTop(snapProps, windows, newTop);
        }
        this.nextTop = newTop;
    ...
    calculateResize(event) {
        ...
        if (event.altKey) {
            ...
            if (resizingSides.left === true) {
                const newLeft2 = snap_1.maybeSnapLeft(rect, windows, newLeft);
                newWidth += newLeft - newLeft2;
                newLeft = newLeft2;
            }
            if (resizingSides.top === true) {
                const newTop2 = snap_1.maybeSnapTop(rect, windows, newTop);
                newHeight += newTop - newTop2;
                newTop = newTop2;
            }
            if (resizingSides.bottom === true) {
                newHeight = snap_1.maybeSnapTop(rect, windows, newTop + newHeight) - newTop;
            }
            if (resizingSides.right === true) {
                newWidth = snap_1.maybeSnapLeft(rect, windows, newLeft + newWidth) - newLeft;
            }
        }
    ...
    calculateResizable(event) {
        ...
        if (((_a = this.state.resizingSides) === null || _a === void 0 ? void 0 : _a.bottom) === bottom &&
            ((_b = this.state.resizingSides) === null || _b === void 0 ? void 0 : _b.left) === left &&
            ((_c = this.state.resizingSides) === null || _c === void 0 ? void 0 : _c.top) === top &&
            ((_d = this.state.resizingSides) === null || _d === void 0 ? void 0 : _d.right) === right &&
